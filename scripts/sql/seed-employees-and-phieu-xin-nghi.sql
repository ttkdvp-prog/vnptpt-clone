...
-- Mirror: prisma/migrations/20260718100000_seed_employees_and_phieu_xin_nghi/migration.sql
-- Run: npx prisma db execute --schema prisma/schema.prisma --file scripts/sql/seed-employees-and-phieu-xin-nghi.sql
