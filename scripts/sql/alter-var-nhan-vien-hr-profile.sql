-- Manual Postgres script (idempotent) — hồ sơ nhân sự bổ sung
-- Equivalent: prisma/migrations/20260718090000_employee_hr_profile_fields/migration.sql
-- Run: psql "$DATABASE_URL" -f scripts/sql/alter-var-nhan-vien-hr-profile.sql
