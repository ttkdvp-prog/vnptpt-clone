-- Thiết lập tài liệu — loại tài liệu
-- Official path: Prisma Migrate (prisma/migrations/20260717030000_thiet_lap_tai_lieu).
-- This file is for manual/emergency apply.

CREATE TABLE IF NOT EXISTS "tai_lieu_thiet_lap_loai_tai_lieu" (
    "id" SERIAL NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "tai_lieu_thiet_lap_loai_tai_lieu_ten_loai_tai_lieu_key"
  ON "tai_lieu_thiet_lap_loai_tai_lieu"("ten_loai_tai_lieu");
