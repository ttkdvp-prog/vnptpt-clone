...
export const queryKeys = {
  ...
  /** TV wallboard `/tong-quan` — aggregate snapshots, refetch on interval */
  wallboard: {
    all: ['wallboard'] as const,
    nhanSu: (params: { date: string }) => ['wallboard', 'nhan-su', params] as const,
    ticker: ['wallboard', 'ticker'] as const,
    weather: ['wallboard', 'weather'] as const,
  },
} as const;
