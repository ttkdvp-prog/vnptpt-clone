...
-- CreateIndex
CREATE INDEX "kh_nguoi_lien_he_id_khach_hang_idx" ON "kh_nguoi_lien_he"("id_khach_hang");

-- AddForeignKey
ALTER TABLE "kh_nguoi_lien_he" ADD CONSTRAINT "kh_nguoi_lien_he_id_khach_hang_fkey"
  FOREIGN KEY ("id_khach_hang") REFERENCES "kh_danh_sach_khach_hang"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- Seed: người liên hệ mẫu (join theo mã KH — không hardcode id)
