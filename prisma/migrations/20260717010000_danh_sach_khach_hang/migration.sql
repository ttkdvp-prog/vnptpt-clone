-- CreateTable
CREATE TABLE "kh_danh_sach_khach_hang" (
    "id" SERIAL NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "kh_danh_sach_khach_hang_ma_khach_hang_key" ON "kh_danh_sach_khach_hang"("ma_khach_hang");

-- CreateIndex
CREATE INDEX "kh_danh_sach_khach_hang_id_nhom_idx" ON "kh_danh_sach_khach_hang"("id_nhom");

-- CreateIndex
CREATE INDEX "kh_danh_sach_khach_hang_id_trang_thai_idx" ON "kh_danh_sach_khach_hang"("id_trang_thai");

-- AddForeignKey
ALTER TABLE "kh_danh_sach_khach_hang" ADD CONSTRAINT "kh_danh_sach_khach_hang_id_nhom_fkey"
  FOREIGN KEY ("id_nhom") REFERENCES "kh_thiet_lap_nhom_khach_hang"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "kh_danh_sach_khach_hang" ADD CONSTRAINT "kh_danh_sach_khach_hang_id_trang_thai_fkey"
  FOREIGN KEY ("id_trang_thai") REFERENCES "kh_thiet_lap_trang_thai"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- Seed: khách hàng mẫu (join theo tên nhóm/trạng thái — không hardcode id)
