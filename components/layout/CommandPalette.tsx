...
const PATH_ICONS: Record<string, LucideIcon> = {
  ...
  '/hanh-chinh': ClipboardList,
  '/hanh-chinh/phieu-hanh-chinh': FileText,
  '/hanh-chinh/cham-diem-kpi': Award,
  '/hanh-chinh/bang-cong': CalendarCheck,
  '/hanh-chinh/bang-luong': Wallet,
  '/hanh-chinh/thiet-lap-cong-luong': Settings2,
  '/hanh-chinh/danh-sach-tai-lieu': Files,
  '/hanh-chinh/thong-ke-tai-lieu': BarChart3,
  '/hanh-chinh/thiet-lap-tai-lieu': FolderCog,
  '/san-xuat': Factory,
  '/kinh-doanh': Handshake,
  '/kinh-doanh/khach-hang': Users,
  '/kinh-doanh/nguoi-lien-he': ContactRound,
  '/kinh-doanh/thiet-lap-khach-hang': Settings2,
