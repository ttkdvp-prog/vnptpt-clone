...
} from '@/features/hanh-chinh/phieu-hanh-chinh/core/types';
...
export const STATUS_COLORS: Record<string, string> = {
  [PHIEU_HANH_CHINH_STATUS.CHO_QL_DUYET]: '#f59e0b',
  [PHIEU_HANH_CHINH_STATUS.CHO_HCNS_DUYET]: '#3b82f6',
  [PHIEU_HANH_CHINH_STATUS.DA_DUYET]: '#10b981',
  [PHIEU_HANH_CHINH_STATUS.TU_CHOI]: '#f43f5e',
  [PHIEU_HANH_CHINH_STATUS.DA_HUY]: '#94a3b8',
};

export const STATUS_LABELS = PHIEU_HANH_CHINH_STATUS_LABELS;
...
export const STATS_KPI_STORAGE_KEY = 'admin-form-stats-kpi';
