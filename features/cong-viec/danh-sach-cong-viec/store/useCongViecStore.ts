...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'tep_dinh_kem', label: txt('congViec.store.tepDinhKemCol'), visible: true, ...P.enumBadgeShort, order: 1.5, priority: 3 },
  { id: 'trang_thai', label: txt('congViec.store.trangThaiCol'), visible: true, ...P.enumBadge, order: 2, priority: 1 },
  ...
  { id: 'ngay_ht', label: txt('congViec.store.ngayHtCol'), visible: true, ...P.enumBadgeShort, order: 12, priority: 3 },
  { id: 'ghi_chu', label: txt('congViec.store.ghiChuCol'), visible: true, ...P.personName, order: 13, priority: 3 },
  { id: 'cap', label: txt('congViec.store.capCol'), visible: true, ...P.enumBadgeShort, order: 14, priority: 2 },
];
